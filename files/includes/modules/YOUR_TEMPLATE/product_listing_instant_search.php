...
/**
 * Adaptation of ZC 2.2.2 /modules/responsive_classic/product_listing.php 
...
$zco_notifier->notify('NOTIFY_MODULE_INSTANT_SEARCH_LISTING_RESULTCOUNT', $listing_split->number_of_rows);
//eof
...
//echo zen_draw_form('multiple_products_cart_quantity', zen_href_link(FILENAME_DEFAULT, zen_get_all_get_params(['action']) . 'action=multiple_products_add_product', $request_type), 'post', 'enctype="multipart/form-data"');
    echo zen_draw_form('multiple_products_cart_quantity', zen_href_link(FILENAME_INSTANT_SEARCH_RESULT, zen_get_all_get_params(array('action')) . 'action=multiple_products_add_product', $request_type), 'post', 'enctype="multipart/form-data"');
//eof
}
